        ...
        <aside class='main-sidebar'>
            <section class='sidebar'>
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
                    ...
                    <li><a href='<?= $homeurl ?>/logout.php'><i class='fa fa-sign-out-alt'></i> <span>Keluar</span></a></li>
                </ul><!-- /.sidebar-menu -->
            </section>
        </aside>
            ...
            <section class='content' style="margin-top:-95px">
                ...
                <?php elseif ($pg == 'testongoing') : ?>
                    ...
                    if ($cek <> 0) :
                        ...
                        $lamaujian = $query['lama_ujian'];
                        $waktuselesai = $query['waktuselesai'];
                        $no_soal = 0;
                        $no_prev = $no_soal - 1;
                        $no_next = $no_soal + 1;
                        $id_mapel = $idmapel;
    ...
    <?php if ($pg == 'testongoing') : ?>
        <script>
            ...
            function loadsoal(idmapel, idsiswa, nosoal) {
                ...
                if ((nosoal + 1) == <?= $jumsoal ?>) {
                    var sisawaktu = $('#countdown').html();
                    var lamaujian = <?= $lamaujian ?>;
                    var waktuselesai = <?= $waktuselesai ?>;
                }
