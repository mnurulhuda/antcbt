                        ...
                        <table class='table table-bordered table-striped  table-hover'>
                            ...
                            <tbody>
                                ...
                                if ($pengawas['level'] == 'guru') {
                                    $ujianQ = mysqli_query($koneksi, "SELECT * FROM nilai a join mapel b ON a.id_mapel=b.id_mapel where b.idguru='$id_pengawas' and b.status = 1 group by id_ujian");
                                } else {
                                    $ujianQ = mysqli_query($koneksi, "SELECT * FROM nilai a join mapel b ON a.id_mapel=b.id_mapel and b.status = 1  group by id_ujian");
                                }
                ...
                $(document).on('click', '.kirimhasil', function() {
                    ...
                    swal({
                        ...
                        if (result.value) {
                            $.ajax({
                                type: 'POST',
                                url: 'mod_sinkron/pusat/prosesnilai.php',
                                data: 'id=' + idujian,
                                beforeSend: function() {
