                ...
                <div class='box-header with-border '>
                    ...
                    <div class='box-tools pull-right '>
                        <?php if ($setting['server'] == 'pusat') : ?>
                            <button id='btnaktif' class='btn btn-sm btn-primary'>Aktifkan</button>
                        ...
                        <table id='example1' class='table table-bordered table-striped'>
                            ...
                            <tbody>
                                ...
                                if ($pengawas['level'] == 'admin') :
                                    $mapelQ = mysqli_query($koneksi, "SELECT * FROM mapel WHERE status = 0 ORDER BY date ASC");
                            ...
                            <div class="col-md-6">
                                <div class='form-group'>
                                    ...
                                    <select name='nama' class='form-control' required='true'>
                                        ...
                                        $pkQ = mysqli_query($koneksi, "SELECT * FROM mata_pelajaran ORDER BY nama_mapel ASC");
                                        while ($pk = mysqli_fetch_array($pkQ)) {
                                            echo "<option value='$pk[kode_mapel]'>$pk[nama_mapel] - $pk[kode_mapel]</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                                                        ...
                                                        <table width=100%>
                                                            <tr>
                                                                ...
                                                                <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                                    ...
                                                                    if ($soal['pilA'] <> '') {
                                                                        // echo "$soal[pilA] ";
                                                                        $va = str_replace('<img src="../../files','<img src="../files',$soal['pilA']);
                                                                        echo $va;
                                                                    }
                                                                ...
                                                                <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                                    ...
                                                                    if (!$soal['pilC'] == "") {
                                                                        // echo "$soal[pilC] ";
                                                                        $vc = str_replace('<img src="../../files','<img src="../files',$soal['pilC']);
                                                                        echo $vc;
                                                                    }
                                                                ...
                                                                <?php if ($namamapel['opsi'] == 5) : ?>
                                                                    ...
                                                                    <td style="padding: 3px; vertical-align: text-top;">
                                                                        ...
                                                                        if (!$soal['pilE'] == "") {
                                                                            // echo "$soal[pilE] ";
                                                                            $ve = str_replace('<img src="../../files','<img src="../files',$soal['pilE']);
                                                                        echo $ve;
                                                                        }
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                                    ...
                                                                    if (!$soal['pilB'] == "") {
                                                                        // echo "$soal[pilB] ";
                                                                        $vb = str_replace('<img src="../../files','<img src="../files',$soal['pilB']);
                                                                        echo $vb;
                                                                    }
                                                                ...
                                                                <?php if ($namamapel['opsi'] <> 3) : ?>
                                                                    ...
                                                                    <td style="padding: 3px;width: 31%; vertical-align: text-top;">
                                                                        ...
                                                                        if (!$soal['pilD'] == "") {
                                                                            // echo "$soal[pilD] ";
                                                                            $vd = str_replace('<img src="../../files','<img src="../files',$soal['pilD']);
                                                                        echo $vd;
                                                                        }
    ...
    $(function() {
        $("#btnaktif").click(function() {
            ...
            swal({
                ...
                text: 'Apakah kamu yakin akan mengaktifkan data bank soal yang sudah dipilih  ini ??',
                type: 'warning',
                ...
                if (result.value) {
                    $.ajax({
                        url: 'mod_banksoal/crud_banksoal.php?pg=aktif',
                        data: "kode=" + id_array,
                        type: "POST",
