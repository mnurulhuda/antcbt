                        ...
                        <table id='example1' class='table table-bordered table-striped'>
                            ...
                            <tbody>
                                ...
                                if ($pengawas['level'] == 'admin') :
                                    $mapelQ = mysqli_query($koneksi, "SELECT * FROM mapel WHERE status = 1 ORDER BY date ASC");
            ...
            <div class='box box-solid'>
                <div class='box-header with-border '>
                    ...
                    <div class='box-tools pull-right '>
                        ...
                        <a href='?pg=<?= $pg ?>&ac=importsoal&id=<?= $id_mapel ?>' class='btn btn-info btn-flat btn-sm'><i class='fa fa-upload'></i> Import</a>
    ...
    $(function() {
        $("#btnnonaktif").click(function() {
            ...
            swal({
                ...
                text: 'Apakah kamu yakin akan menonaktifkan data bank soal yang sudah dipilih  ini ??',
                type: 'warning',
                ...
                if (result.value) {
                    $.ajax({
                        url: 'mod_banksoal/crud_banksoal.php?pg=nonaktif',
                        data: "kode=" + id_array,
                        type: "POST",
