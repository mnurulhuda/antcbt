                        ...
                        <td style="text-align:center">
                            ...
                            <?php } elseif (($no_soal >= 0) && ($cekno_soal = $jumsoalpg) && ($jumsoalesai == 0)) { ?>
                                ...
                                <button class='done-btn btn btn-danger' style='width:150px;' id="btnselesai" disabled>
                                    ...
                                    $sisajam = $sisawaktu[0];
                                    $sisamenit = $sisawaktu[1];
                                    $sisadetik = $sisawaktu[2];

                                    $jam = $sisajam * 3600;
                                    $menit = $sisamenit * 60;
                                    $totaldetik = $jam + $menit + $sisadetik;

                                    $lamaujian = $_POST['lamaujian'] * 60;
                                    $waktuberjalan = $lamaujian - $totaldetik;

                                    $sisawaktuselesai = $waktuselesai * 60 - $waktuberjalan;
                                    
                                    $dtk = $sisawaktuselesai % 60;
